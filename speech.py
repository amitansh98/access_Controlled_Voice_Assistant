        ...
        if(t.find("download")!=-1):
            ...
            with sr.Microphone() as source:
                ...
                if(b.find("yes")!=-1):                                              # Download youtube video
                    ...
                    s.download("Desktop",quiet=True,callback=myfun)                #Change your download location here
            ...
            if(t=="calculator" or t=="Calculator"):
                ...
                os.system(r'''start C:\\\Users\\\sande\\\Downloads\\\Programs\\\ChromeSetup.exe''')
                mlist.append(r'''C:\\\Users\\\sande\\\Downloads\\\Programs\\\ChromeSetup.exe''')
